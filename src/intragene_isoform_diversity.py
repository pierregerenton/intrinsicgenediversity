...
def main():
    ...
    shuffle : gtga.Annotation = gtga.make_shuffle_copy(annotation)
    ...
    data['Type'] = "Observed"
    data['Number of isoform'] = data['Gene'].apply(annotation.get_gene).apply(gtga.Gene.number_of_isoforms)
    ...
    data['Dice coefficient'] = data['Gene'].apply(annotation.get_gene).apply(gtga.Gene.diversity_by_pair, similarity_function=gtga.dice_coefficient)
    data['Overlap coefficient'] = data['Gene'].apply(annotation.get_gene).apply(gtga.Gene.diversity_by_pair, similarity_function=gtga.overlap_coefficient)
    data['Redundance metric'] = data['Gene'].apply(annotation.get_gene).apply(gtga.Gene.go_redundance_metric)
    data['Stdev number GO term'] = data['Gene'].apply(annotation.get_gene).apply(gtga.Gene.stdev_number_of_go_by_isoform)
    similarity = data['Gene'].apply(annotation.get_gene).apply(gtga.Gene.intra_gene_gogo_similarity, gogo_dir=args.gogo_dir, gogo_file='iig.observed.'+basename(args.input).strip('.out'))
    ...
    reassignment['Number of isoform'] = reassignment['Gene'].apply(shuffle.get_gene).apply(gtga.Gene.number_of_isoforms)
    reassignment['Jaccard Index'] = reassignment['Gene'].apply(shuffle.get_gene).apply(gtga.Gene.diversity_by_pair, similarity_function=gtga.jaccard_index)
    reassignment['Dice coefficient'] = reassignment['Gene'].apply(shuffle.get_gene).apply(gtga.Gene.diversity_by_pair, similarity_function=gtga.dice_coefficient)
    reassignment['Overlap coefficient'] = reassignment['Gene'].apply(shuffle.get_gene).apply(gtga.Gene.diversity_by_pair, similarity_function=gtga.overlap_coefficient)
    reassignment['Redundance metric'] = reassignment['Gene'].apply(shuffle.get_gene).apply(gtga.Gene.go_redundance_metric)
    reassignment['Stdev number GO term'] = reassignment['Gene'].apply(shuffle.get_gene).apply(gtga.Gene.stdev_number_of_go_by_isoform)
    similarity = reassignment['Gene'].apply(shuffle.get_gene).apply(gtga.Gene.intra_gene_gogo_similarity, gogo_dir=args.gogo_dir, gogo_file='iig.expected.'+basename(args.input).strip('.out'))
